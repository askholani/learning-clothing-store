...
-- CreateTable
CREATE TABLE "detail_transactions_without_login" (
    "id_detail_transactions_without_login" INTEGER NOT NULL,
    ...
    CONSTRAINT "detail_transactions_without_login_pkey" PRIMARY KEY ("id_detail_transactions_without_login")
);
