  ...
  return (
    <>
      <section className='grid justify-between grid-cols-12 uppercase text-sekunder sm:border-b sm:pb-16 mt-8 items-end gap-y-4'>
        ...
        <div className='flex justify-end w-full col-span-6 md:col-span-12 lg:col-span-2'>
          <span onClick={handleOpenFilter} className='hover:cursor-pointer'>
            filter
          </span>
        </div>
      </section>
      <motion.section className='relative' animate={open ? 'open' : 'closed'}>
        <motion.div
          className='flex flex-col gap-y-8 py-4 bg-primer z-20 w-full md:w-[40%] absolute'
          variants={{
          ...
          <div className='w-full flex flex-col gap-y-2'>
            <span className='text-xs sm:text-base'>color </span>
            <div className='w-full flex justify-between md:flex-col gap-y-2'>
              <div className='flex items-center gap-x-1 md:gap-x-4'>
                <input
                  type='checkbox'
