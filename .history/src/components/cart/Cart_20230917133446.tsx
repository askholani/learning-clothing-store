  ...
  return (
    <>
      ...
      {/* <div className='relative flex'>
        <div className='relative z-20 flex flex-col gap-y-2 mx-2'>
          <label>
            <input
              defaultChecked={items?.selected ? items.selected : false}
              onChange={handleChoiceItems}
              type='checkbox'
              className='checkbox bg-sekunder w-[2rem] h-[2rem] rounded-full border border-sekunder bg-transparent '
            />
          </label>
          <button
            className='btn btn-xs w-[2rem] h-[2rem] rounded-full bg-transparent broder border-sekunder'
            onClick={handleShowModal}>
            <span className='text-base'>
              <XMarkIcon className='w-5 h-5 text-sekunder' />
            </span>
          </button>
        </div>
        <div className='flex flex-col'>
          ...
          <div className='join rounded-none '>
            ...
            <button className='join-item btn  bg-primer text-sekunder border-none hover:bg-primer justify-center'>
              {quantity}
            </button>
            <button
              className='join-item btn  bg-primer text-sekunder border-none hover:bg-primer'
        ...
        <div className='flex flex-col gap-y-3'>
          <label>
            <input
              ...
              onChange={handleChoiceItems}
              type='checkbox'
              className='checkbox bg-sekunder w-[1.3rem] h-[1.3rem] rounded-full border border-sekunder bg-transparent '
            />
          </label>
          <button
            className='btn btn-xs w-[1.3rem] h-[1.3rem] rounded-full bg-transparent broder border-sekunder'
            onClick={handleShowModal}>
            <span className='text-base'>
              <XMarkIcon className='w-3 h-3 text-sekunder' />
            </span>
          </button>
        </div>
        <div className='flex-flex-col'>
