...
export default function Cart(props: { items: itemType }) {
  return (
    <tr>
      ...
      <td className=''>
        <div className='overflow-hidden w-[15rem] flex items-start h-[100%]'>
          <p>
      ...
      <td className='text-start h-[100%] flex  items-start justify-start'>
      ...
      <td className='text-2xl flex items-start justify-start'>
        <h3>900$</h3>
      </td>
    </tr>
  )
