...
export default function Cart(props: { items?: itemType; dispatch: any }) {
  ...
  const handleRemove = () => {
    dispatch({ type: 'REMOVE', item: items as itemType })
  }
  ...
  return (
    <tr>
      <td className='flex flex-col gap-y-2 items-start'>
        ...
        <button className='btn btn-xs w-[2rem] h-[2rem]' onClick={handleRemove}>
