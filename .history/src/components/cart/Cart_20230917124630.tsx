        ...
        <div className='relative z-20 flex flex-col gap-y-2 mx-2'>
          <label>
            <input
              ...
              type='checkbox'
              className='checkbox bg-sekunder w-[2rem] h-[2] rounded-full border border-sekunder bg-transparent '
            />
          </label>
          <button
            className='btn btn-xs w-[2] h-[2] rounded-full bg-transparent broder border-sekunder'
