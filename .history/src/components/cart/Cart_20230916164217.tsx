      ...
      <tr>
        ...
        <td>
          <div className='flex flex-col lg:flex-row gap-x-2 gap-y-4'>
            <div className='w-[10rem] h-[13rem] bg-sekunder col-span-2'>
              <Image
            ...
            <div className='flex flex-col justify-between col-span-3 gap-y-2'>
        ...
        <td>
          <div className='overflow-hidden sm:flex items-start hidden'>
            <p>{description}</p>
          </div>
        </td>
