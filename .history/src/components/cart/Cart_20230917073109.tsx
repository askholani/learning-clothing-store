      ...
      <tr>
        <td className='flex flex-col gap-y-2 items-start px-1'>
          <label>
            <input
              ...
              type='checkbox'
              className='checkbox border border-sekunder w-[2rem] h-[2rem] rounded-full'
            />
          </label>
          <button
            className='btn btn-xs w-[2rem] h-[2rem] rounded-full'
        ...
        <td className='px-2'>
          <div className='flex items-start gap-x-2'>
            <div className='flex flex-col lg:flex-row gap-x-2 gap-y-4 relative w-[50%]'>
        ...
        {/* <td className='px-2 object-cover'>
          <div className='flex flex-col justify-between h-full'>
            <div className='flex flex-col justify-between col-span-3 gap-y-2 relative'>
              <h2 className='text-base lg:text-xl font-bold'>{name}</h2>
              <div className='flex flex-col font-normal lg:font-bold'>
        ...
        <td className='flex px-2 py-1 items-start'>
          <p>{description}</p>
        </td>
