      ...
      <div className='mt-16 sm:mt-0'>
        <div className='flex justify-center mt-24 py-4 relative items-center'>
          ...
          <div className=' w-full absolute uppercase'>
            ...
            <div>
              <h3 className='text-2xl sm:text-6xl font-bold bg-primer'>
                we do not follow
              </h3>
              <div className='flex'>
                <p className='w-[20rem] text-xs normal-case bg-primer'>
                  with a strong on simple yet powerful design we are driven to
                  create timeless work by portraying an aesthetic that is
                  uniquely our own
                </p>
                <h3 className='font-bold text-2xl sm:text-6xl mx-4 bg-primer'>
                  fashion, but
                </h3>
