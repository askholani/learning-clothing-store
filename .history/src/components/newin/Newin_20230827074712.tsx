  ...
  return (
    <section className='flex flex-col border-b py-4 relative overflow-hidden'>
      <div className='w-full uppercase'>
        ...
        <div className='flex justify-between my-4 sm:my-12'>
          <motion.h2
            ...
            transition={{ duration: 0.4 }}
            className='text-2xl sm:text-6xl font-extrabold'>
            new in
          </motion.h2>
          <Link
            className='flex items-end underline hover:cursor-pointer text-xs sm sm:text-base'
            href={`/shop?date=new`}
            prefetch={true}>
            see all
          </Link>
      ...
      <div className='flex justify-center mt-16 sm:mt-24 py-4 relative items-center'>
        <div className='h-[25rem] w-[18rem] absolute'>
        ...
        <div className=' w-full absolute uppercase -top-4 '>
          ...
          <motion.div
            ...
            whileInView={{ y: 0, opacity: 1, scale: 1 }}
            transition={{ duration: 0.4 }}>
            <h3 className='text-2xl sm:text-6xl font-bold'>we do not follow</h3>
            <div className='flex'>
              <p className='w-[20rem] text-xs normal-case'>
                with a strong on simple yet powerful design we are driven to
                create timeless work by portraying an aesthetic that is uniquely
                our own
              </p>
