import { generalType, productsType } from '@components/utils/type'
import AccordionHome from '../accordion/AccordionHome'
import Item from '../item/Item'

export default async function About(props: {
  aboutProduct: productsType[]
  dataCollection: generalType[]
}) {
  const { aboutProduct, dataCollection } = props
  return (
    <section className='flex flex-col gap-x-4 py-12'>
      ...
      <AccordionHome dataCollection={dataColletion} />
    </section>
  )
}
