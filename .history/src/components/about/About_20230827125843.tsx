  ...
  return (
    <section className='flex flex-col gap-x-4 sm:py-8 py-4'>
      <div className='grid grid-cols1 sm:grid-cols-3'>
        <div className='col-span-1 md:col-span-2 uppercase'>
          <motion.h1
            initial={{ x: '-100%', opacity: 0.7 }}
            whileInView={{ x: 0, opacity: 1 }}
            transition={{ duration: 0.4 }}
            className='text-md mb-4 sm:mb-16'>
            about the brand
          </motion.h1>
          <motion.h1
            ...
            transition={{ duration: 0.4 }}
            className='text-xl sm:text-2xl w-full sm:w-[65%]'>
        ...
        <motion.div
          ...
          className='col-span-1 grid grid-cols-2 gap-x-4'>
          <div>
