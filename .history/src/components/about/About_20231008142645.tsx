  ...
  return (
    <section className='flex flex-col gap-x-4 sm:py-8 py-4 overflow-hidden'>
      <div className='grid grid-cols-1  lg:grid-cols-5'>
        <div className='col-span-1 lg:col-span-3 uppercase'>
          <motion.h1
        ...
        <motion.div
          ...
          className='col-span-2 gap-y-2 mt-4 lg:col-span-2 grid grid-cols-2 gap-x-4 md:gap-x-2 sm:px-20 md:px-0 h-[30vh] sm:h-[50vh]'>
          <div className='w-full h-full mx-auto overflow-hidden relative'>
            <ImageComp
              alt='about-image-1'
              src={aboutProduct && aboutProduct[0].image}
          ...
          <div className='w-full h-full mx-auto overflow-hidden relative'>
            <ImageComp
              src={aboutProduct && aboutProduct[1].image}
              alt='about-image-2'
              sizes='(min-width: 780px) calc(20vw - 30px), (min-width: 640px) calc(50vw - 120px), calc(50vw - 24px)'
              className='object-cover'
              quality={100}
