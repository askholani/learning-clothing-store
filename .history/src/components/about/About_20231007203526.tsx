    ...
    <section className='flex flex-col gap-x-4 sm:py-8 py-4 overflow-hidden'>
      <div className='grid grid-cols-1  md:grid-cols-5'>
        ...
        <motion.div
          ...
          className='col-span-1 md:col-span-2 grid grid-cols-1 gap-x-4 md:gap-x-2 sm:px-20 md:px-0'>
          <div className='w-full relative'>
            <Item
              image={aboutProduct[0].image}
              size='(min-width: 780px) calc(20vw - 30px), (min-width: 640px) calc(50vw - 120px), calc(50vw - 24px)'
              priority={true}
              classNameItem='h-[40vh]'
            />
            <p className='text-end'>01</p>
          </div>
          <div>
            <Item
              image={aboutProduct[1].image}
              size='(min-width: 780px) calc(20vw - 30px), (min-width: 640px) calc(50vw - 120px), calc(50vw - 24px)'
              classNameItem='h-[40vh] relative'
              priority={true}
            />
