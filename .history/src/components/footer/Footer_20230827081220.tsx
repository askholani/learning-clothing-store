    ...
    <footer className='uppercase mt-4 sm:mt-16 relative overflow-hidden'>
      <section className='flex flex-col'>
        ...
        <div className='flex flex-col uppercase'>
          ...
          <div className='sm:w-[40%] w-full flex gap-x-4 font-bold justify-center mt-4'>
            <div className='flex flex-col'>
              <div className='text-xs sm:text-base flex gap-x-2'>
                <h3>site</h3>
                <h3>Navigation</h3>
              </div>
              <div className='text-xs font-normal mt-4 sm:mt-16 flex flex-col gap-y-2'>
                <h4>about</h4>
                <h4>contacts</h4>
                <h4>delivery</h4>
                <h4>shop</h4>
            ...
            <div className='flex flex-col gap-y-4'>
              ...
              <div className='text-xs font-normal sm:mt-16 flex flex-col gap-y-2'>
                <h4>instagram</h4>
                <h4>twitter</h4>
                <h4>facebook</h4>
                <h4>mail</h4>
      ...
      <section className='flex border-t justify-between py-4 text-xs'>
