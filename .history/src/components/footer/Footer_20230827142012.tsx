  ...
  return (
    <footer className='uppercase mt-4 sm:mt-8 md:mt-16 relative overflow-hidden'>
      <section className='flex flex-col'>
        ...
        <div className='mt-16 flex flex-col md:flex-row uppercase md:w-[70%]'>
          <div className='w-full'>
            ...
            <div className='flex border-b sm:w-[60%] w-full mt-4 sm:mt-8 md:mt-16 items-center pb-4 justify-between'>
