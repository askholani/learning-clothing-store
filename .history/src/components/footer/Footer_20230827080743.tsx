      ...
      <section className='flex flex-col'>
        ...
        <div className='flex flex-col uppercase'>
          <div className='sm:w-[60%]'>
            ...
            <div className='flex border-b w-[40%] mt-4 sm:mt-16 items-center pb-4 justify-between'>
              <h4 className='text-xs'>Email</h4>
              <ArrowLongRightIcon className='h-[2rem]' />
            </div>
          </div>
          <div className='sm:w-[40%] w-full flex gap-x-4 font-bold'>
            <div className='flex flex-col'>
              <div className='text-xs sm:text-base flex flex-col flex'>
                <h3>site</h3>
                <h3>Navigation</h3>
              </div>
