      ...
      <div className='col-span-2 sm:col-span-8 w-full relative'>
        <div className='uppercase'>
          ...
          <div className='w-full z-10 relative'>
            ...
            <br />
            <span className='flex-col sm:flex w-[90%]'>
              <span className='normal-case w-[12rem] text-xs me-4 order-last sm:order-1'>
                A new collection of clothes was created for hiking. in our
                clothes you will feel as comfortable as in your everyday life.
              </span>
              <span className='text-3xl md:text-6xl font-bold'>collection</span>
            </span>
