      ...
      <div className='absolute w-full col-span-2 sm:col-span-6  sm:relative mt-4 sm:mt-0'>
        <div className='uppercase relative'>
          <motion.div
            ...
            className='text-xs w-full my-2 sm:ml-0 sm:my-0'>
          ...
          <div className='w-full z-10 sm:relative absolute mt-8 sm:mt-2 flex flex-col justify-center items-center'>
            <div className='w-[80%] sm:w-full'>
              <span className='text-3xl md:text-5xl sm:text-4xl font-bold bg-primer'>
                capsule
              </span>
              <br />
              <div className='flex-col sm:flex w-[90%]'>
                <motion.span
                  ...
                  className='text-3xl md:text-5xl sm:text-4xl font-bold block text-end md:my-4'>
              ...
              <motion.span
                ...
                whileInView={{ opacity: 1, scale: 1 }}
                transition={{ duration: 0.3 }}
                className='text-3xl md:text-5xl sm:text-4xl font-bold block'>
              ...
              <motion.div
                ...
                whileInView={{ opacity: 1, scale: 1 }}
                transition={{ duration: 0.4 }}
                className='text-3xl md:text-5xl sm:text-4xl font-bold text-end w-full'>
