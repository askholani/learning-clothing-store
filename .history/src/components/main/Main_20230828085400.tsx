...
export default function Main(props: { newProduct: productsType[] }) {
  ...
  return (
    <section className='grid grid-cols-2 sm:grid-cols-12 mt-4 sm:gap-x-4 md:py-12 border-b-2 pb-4'>
      ...
      <div className='col-span-2 sm:col-span-6 w-full absolute sm:relative mt-4 sm:mt-0 flex flex-col justify-center'>
        <div className='uppercase relative'>
          ...
          <div className='sm:w-full z-10 sm:relative absolute mt-8 sm:mt-2 w-[60%]'>
