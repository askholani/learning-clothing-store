...
export default function Main(props: { newProduct: productsType[] }) {
  ...
  return (
    <section className='grid grid-cols-2 sm:grid-cols-12 mt-4 gap-x-4 md:py-12 border-b-2 overflow-hidden'>
      <div className='col-span-2 sm:col-span-4 relative h-[70vh]'>
        <ImageComp
