...
export default function Main(props: { newProduct: productsType[] }) {
  ...
  return (
    <section className='grid grid-cols-2 sm:grid-cols-12 mt-4 sm:gap-x-4 md:py-12 border-b-2 overflow-hidden pb-4'>
      <motion.div
        className='col-span-2 sm:col-span-6 relative h-[60vh] md:h-[80vh]'
        initial={{ opacity: 0.4 }}
        ...
        <div className='w-full h-full justify-end hidden md:flex'>
          <div className='relative md:h-[10rem] md:w-[10rem] mt-4'>
            <Rounded icon={true} content='discovery' />
          </div>
        </div>
      </motion.div>
      <div className='col-span-2 sm:col-span-6 w-full relative mt-4 sm:mt-0'>
          ...
          <div className='w-full z-10 sm:relative absolute mt-8 sm:mt-2'>
            ...
            <div className='flex-col sm:flex w-[90%]'>
              <motion.span
                ...
                className='text-3xl md:text-5xl font-bold block text-end '>
