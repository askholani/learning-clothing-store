...
export default function Main(props: { newProduct: productsType[] }) {
  ...
  return (
    <section className='grid grid-cols-2 sm:grid-cols-12 mt-4 sm:gap-x-4 md:py-12 border-b-2 overflow-hidden pb-4'>
      <motion.div
        className='col-span-2 sm:col-span-4 relative h-[60vh] sm:h-[70vh]'
        initial={{ opacity: 0.4 }}
      ...
      <div className='col-span-2 sm:col-span-8 w-full relative mt-4 sm:mt-0'>
        <div className='uppercase relative'>
          ...
          <div className='w-full z-10 sm:relative absolute mt-8'>
          ...
          <div className='sm:h-[50vh] sm:w-[18rem] h-[60vh] relative sm:absolute bottom-0 right-0'>
            <ImageComp
