  ...
  return (
    <nav className='navbar bg-primer'>
      ...
      <div className='shrink  w-[30%] md:flex flex-col items-end hidden'>
        <Link href='/cart' className='flex justify-between md:w-[40%] w-[100%]'>
          <span>cart</span>
          <span>[ {cartAmount} ]</span>
        </Link>
        <Link
          href='/wishlist'
          className='flex justify-between md:w-[40%] w-[80%] '>
          <span>wishlist</span>
          <span>[ 0 ]</span>
        </Link>
        <Link href='/login' className='flex justify-between md:w-[40%] w-[80%]'>
          <span>login</span>
          <span>
