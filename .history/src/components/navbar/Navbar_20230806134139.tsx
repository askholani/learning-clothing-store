...
export default function Navbar(props: { categories: []; cookieCart?: string }) {
  ...
  //  const amountOfCartItems = cartItems.reduce(
  //   (accumulator, currentValue) => (qty :{accumulator.qty + currentValue.qty,})
  // )
  console.log('cartItems', cartItems)

  const amountOfCartItems: any = cartItems.reduce(
    (accumulator, currentValue) => accumulator.qty + currentValue.qty,
  )
  console.log('amountOfCartItems', amountOfCartItems)
  ...
  useEffect(() => {
    dispatch({ type: 'GET', defaultItem: cookieCart })
  }, [])
