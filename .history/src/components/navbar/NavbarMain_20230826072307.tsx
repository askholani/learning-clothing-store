  ...
  return (
    <nav className='navbar bg-primer'>
      ...
      <div className='shrink  w-[30%] md:flex flex-col items-end hidden'>
        <Link href='/cart' className='flex justify-between w-[40%]'>
          <span>cart</span>
          <span>[ {cartAmount} ]</span>
        </Link>
        <Link href='/wishlist' className='flex justify-between w-[40%]'>
          <span>wishlist</span>
          <span>[ 0 ]</span>
        </Link>
        <Link href='/login' className='flex justify-between w-[40%]'>
          <span>login</span>
          <span>
