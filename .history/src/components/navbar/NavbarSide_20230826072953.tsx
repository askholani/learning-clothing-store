  ...
  return (
    <>
      <motion.nav animate={open ? 'open' : 'closed'}>
        <motion.div
          className='w-[100%] fixed opacity-0 top-0 bottom-0 '
          variants={{
            open: {
              x: 0,
              opacity: 1,
          ...
          <motion.div className='w-[60%] h-full gap-y-10 px-4 py-4 relative z-20 bg-slate-400'>
            <div className='flex flex-col'>
              <motion.ul
                ...
                <motion.li variants={liVariants}>cart</motion.li>
          ...
          <motion.div
            className='absolute top-0 bottom-0 left-0 right-0 bg-slate-300 opacity-90 flex justify-end items-start'
