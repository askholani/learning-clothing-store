...
export default function SearchBar() {
  ...
  return (
    <>
      ...
      md:grid-cols-3 uppercase text-sekunder sm:border-b sm:pb-16 mt-8 items-end'>
        <div className='text-3xl sm:text-4xl md:text-5xl font-extrabold col-span-1'>
          <h1>shop all</h1>
        </div>
        <div className='col-span-4 justify-end hidden md:flex md:col-span-2'>
