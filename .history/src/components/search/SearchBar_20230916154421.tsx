...
export default function SearchBar() {
  ...
  return (
    <>
      <section className='grid justify-between md:grid-cols-12 uppercase text-sekunder sm:border-b sm:pb-16 mt-8 items-end gap-y-4'>
        ...
        <div
          className='flex justify-end w-full col-span-12 lg:col-span-2'
