  ...
  return (
    <Fragment>
      <section className='grid grid-cols-1 sm:grid-cols-12 gap-x-8 border-b pb-8 md:py-12'>
        <div className='sm:col-span-6 md:col-span-5 md:h-[90vh] h-[80vh] col-span-1'>
          <SwiperType itemProductImages={itemProductImages} />
        </div>
        <div className='col-span-1 sm:col-span-6 md:col-span-7 flex flex-col'>
          ...
          <div className='flex flex-col w-full my-8'>
            ...
            <div className='grid grid-cols-2 sm:grid-cols-1 sm:gap-y-2 my-2 sm:my-4 gap-x-2 sm:gap-x-8'>
            ...
            <div className='grid grid-cols-2 my-2 md:my-4 gap-x-2 md:gap-x-8'>
              <select
