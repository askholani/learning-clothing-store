          ...
          <div className='flex flex-col w-full my-8'>
            <div className='flex justify-between py-4 border-y'>
              <div className='flex gap-x-4'>
                <h4 className='font-bold text-xs sm:text-base'>collection</h4>
                <h4 className='normal-case font-light text-sm'>
                  hiking collection
                </h4>
              </div>
              <div className='flex gap-x-4'>
                <h4 className='font-bold text-xs sm:text-base'>stock</h4>
                <h4 className='normal-case font-light text-xs sm:text-base'>
                  {stock}
                </h4>
              </div>
            </div>
