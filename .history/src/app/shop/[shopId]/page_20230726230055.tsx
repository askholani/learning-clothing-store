...
export default function Page() {
  ...
  const detail = useDetailProduct(id)
  const coba = images.data ? images.data.result.images : ''
  // const productImages = images.data ? images.data.result.images : ''
  // const detailImages = detail.data ? detail.data.results.image : ' '
