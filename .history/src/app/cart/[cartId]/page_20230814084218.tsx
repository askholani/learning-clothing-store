...
import { useCheckoutContext } from '@components/context/ChechkoutContex copy'
import Modal from '@components/components/modal/Moda'
...
export default function Page() {
  ...
  const handleGoToCheckout = () => {
    ...
    console.log('exisitingItemChoice', exisitingItemChoice)
  ...
  return (
    <Fragment>
      {showModal && <Modal onShowRemove={handleShowModal} />}
