...
export default function Page({ params }: { params: { cartId: string } }) {
  ...
  console.log('state page cart', state)
  ...
  console.log('newListItems cart page', newListItems)

  let totalPrice
  if (newListItems) {
    totalPrice = newListItems.reduce((acc: any, curr: any) => {
      console.log('acc', acc)
  ...
  console.log('totalPrice cart page', totalPrice)
