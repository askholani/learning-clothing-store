            ...
            <tr>
              ...
              <td className='text-center'>
                <div className='join rounded-none'>
                  <button className='join-item btn text-sekunder border-none hover:bg-none'>
                    «
                  </button>
                  <button className='join-item btn  bg-primer text-sekunder border-none hover:bg-none'>
                    1
                  </button>
