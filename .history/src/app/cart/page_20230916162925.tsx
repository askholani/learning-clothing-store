        ...
        <table className='table'>
          <thead>
            <tr className='text-sekunder'>
              ...
              <th className='text-center w-[10%] hidden sm:block'>quantity</th>
              <th className='w-[30%] text-center hidden sm:block'>
                description
              </th>
              <th className='w-[10%] text-end hidden sm:block'>price</th>
            </tr>
          </thead>
          <tbody>
