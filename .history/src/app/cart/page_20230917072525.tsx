        ...
        <table className='table'>
          <thead>
            <tr className='text-sekunder'>
              <th className='w-[5%]'></th>
              <th className='w-[95%]  sm:w-[60%]'>product</th>
              {/* <th className='text-center w-[10%] hidden'>quantity</th> */}
              <th className='w-[40%] text-center hidden'>description</th>
              {/* <th className='w-[10%] text-end hidden'>price</th> */}
            </tr>
          </thead>
          <tbody>
