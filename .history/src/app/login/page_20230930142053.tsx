...
export default function Page() {
  return (
    <section className='flex flex-col text-sekunder h-[80vh] sm:h-[100vh] py-8 px-4 gap-y-8 sm:grid grid-cols-2 gap-x-4 items-center'>
      <div className='flex flex-col w-full col-span-1 items-center'>
        ...
        <div className='flex flex-col w-full col-span-1 text-sekunder items-center md:px-8'>
      ...
      <div className='hidden sm:block relative col-span-1 bg-sekunder h-[100%]'>
        <Image
          src={loginImage}
