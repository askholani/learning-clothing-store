...
export default function Page() {
  return (
    <section className='flex flex-col text-sekunder h-[80vh] sm:h-[100vh] py-8 px-4 gap-y-8 sm:grid grid-cols-5 gap-x-4'>
      <div className='flex flex-col w-full col-span-2 items-center'>
      ...
      <div className='hidden sm:block relative col-span-3 bg-sekunder'>
        <Image
          src={loginImage}
