...
export default function Page() {
  return (
    <section className='flex flex-col text-sekunder h-[80vh] py-8 px-4 gap-y-8 sm:grid grid-cols-3 gap-x-4'>
      <div className='flex flex-col w-full col-span-1'>
        ...
        <div className='flex flex-col text-sekunder w-full items-center'>
      ...
      <div className='hidden sm:block relative col-span-2 bg-sekunder'>
        <Image
          src={loginImage}
