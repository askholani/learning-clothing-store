  ...
  return (
    <Fragment>
      <section className='grid grid-cols-1 md:grid-cols-12 gap-x-20'>
        ...
        <div className='col-span-1 md:col-span-6 border-b '>
            ...
            <div>
              ...
              <div className='grid grid-cols-12 gap-4 '>
                ...
                <input
                  type='text'
                  placeholder='CODE'
                  className='input input-bordered  col-span-4 rounded-none text-sekunder bg-primer  h-auto py-2'
                />
                <input
                  type='text'
                  placeholder='PHONE'
                  className='input input-bordered  col-span-8 rounded-none text-sekunder bg-primer  h-auto py-2'
                />
              </div>
            </div>
            <div>
              ...
              <div className='grid grid-cols-12 gap-4'>
                <input
                  ...
                  className='input input-bordered  col-span-6 rounded-none text-sekunder bg-primer  h-auto py-2'
                />
                <input
                  type='text'
                ...
                <input
                  ...
                  className='input input-bordered  col-span-12 rounded-none text-sekunder bg-primer  h-auto py-2'
                />
                <input
                  type='text'
                ...
                <div className='form-control'>
                  <label className='label cursor-pointer justify-normal gap-x-4'>
                    <input
                      type='radio'
                      name='radio-10'
                      className='radio checked:bg-primer border-sekunder  h-auto py-2'
                    />
