      ...
      <section className='grid grid-cols-1 md:grid-cols-12 gap-x-20'>
        ...
        <div className='col-span-1 md:col-span-6'>
          <form onSubmit={handleSubmit}>
            <div>
              <h2 className='text-base tracking-wider py-2'>
              ...
              <div className='grid grid-cols-12 gap-4 '>
                <input
                  ...
                  className='input input-bordered  col-span-12 rounded-none text-sekunder bg-primer py-2'
                />
                <input
                  type='text'
                  placeholder='CODE'
            ...
            <div>
              <h2 className='text-base tracking-wider py-4'>payment</h2>
              <div className='grid grid-cols-12 gap-4'>
