            ...
            <div>
              ...
              <div className='grid grid-cols-12 gap-4'>
                ...
                <select className='select select-bordered col-span-4 rounded-none text-sekunder bg-primer'>
                  <option className='text-sm'>CITY</option>
                  <option className='text-sm'>Han Solo</option>
                  <option className='text-sm'>Greedo</option>
                </select>
                <select className='select select-bordered col-span-4 rounded-none text-sekunder bg-primer'>
                  <option>STATE</option>
                ...
                <div className='form-control'>
                  <label className='label cursor-pointer justify-normal gap-x-4'>
                    <input
                      type='radio'
                      name='radio-10'
                      className='radio checked:bg-primer border-sekunder  h-auto py-2 text-sm'
                    />
