            ...
            <div>
              ...
              <div className='grid grid-cols-12 gap-4'>
                ...
                <input
                  ...
                  className='input input-bordered  col-span-12 rounded-none text-sekunder bg-primer  h-6 w-6 py-2 text-sm'
                />
                <input
                  type='date'
                  placeholder='EXPIRATION DATE *'
                  className='input input-bordered  col-span-6 rounded-none text-sekunder bg-primer  h-6 w-6 py-2 text-sm'
                />
                <input
                  type='text'
                  placeholder='SW*'
