  ...
  switch (action.type) {
    ...
    case 'ADD':
      ...
      if (oldItems.length !== 0) {
        const existingIndexSameIdSize = oldItems.findIndex(
    ...
    //   const existingCartItemChoice = state.findIndex((item , index)=>index === indexCartChoice)
    //   existingCartItem = oldItems[existingCartItemChoice]
  }
  return state
}
