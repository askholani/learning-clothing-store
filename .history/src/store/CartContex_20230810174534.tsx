...
type CartAction =
  ...
  | { type: 'CHOICE'; indexCart: number; choice: boolean }
 ...
 * COOKIES : menyimpan data ke cookies setiap user menghapus, menambahkan, atau "memilih"
  ...
  switch (action.type) {
    ...
    case 'UPDATE':
      ...
      if (
        ...
        // const existingItemUPDATE = updatedItemsUPDATE[indexSameIdandSize]
        // updatedItemUPDATE = {
        //   ...existingItemUPDATE,
        //   qty: newItemUPDATE.qty,
        // }
        // updatedItemsUPDATE[indexSameIdandSize] = updatedItemUPDATE

        updatedItemsUPDATE[indexSameIdandSize] = newItemUPDATE
        console.log('updatedItemUPDATE', updatedItemUPDATE)
        console.log('updatedItemsUPDATE', updatedItemsUPDATE)
